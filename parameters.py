...
frameRate = 24
SAMPLE_RATE = 44100
SILENT_THRESHOLD = 0.04  # 0-1. 1 is max volume
...
MAX_SILENCE_PERMITTED = 40  # length of frames permitted to not count as silence
...
clips_video = {k: v for k, v in clips_images.items() if
               v == "v1" or v == "v2" or v == "v3" or v == "v4" or v == "v5" or v == "v6" or v == "v7" or v == "v8" or v == "v9" or v == "v10" or v == "Video 1" or v == "Video 2" or v == "Video 3" or v == "Video 4" or v == "Video 5"}
...
clips_benALT = {k: v for k, v in clips_images.items() if v in clips_ben.values() and v != "DELETE DONT NEED"}
